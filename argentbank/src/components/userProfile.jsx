...
import ApiProvider from "../services/APIcalls"
import { updateUserData } from "../utils/reducers"
import { selectFirstName, selectUserToken, selectLastName } from "../utils/selectors"
...
function UserProfile() {
    ...
    let JWTtoken = useSelector(selectUserToken)
